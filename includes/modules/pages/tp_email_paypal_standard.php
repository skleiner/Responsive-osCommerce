...
*/
  ...
  class tp_email_paypal_standard {
    var $group = 'email_paypal_standard';
    var $template = '';
    var $title = 'Paypal Standard';
    var $description = 'osCommerce Basic Email Template<br />preview demo generated from <strong>last order</strong> data as a Paypal payment';
    var $section = 'payment';
    var $version = '1.01';

    function prepare() {
      global $oscTemplate;
      $oscTemplate->_email_data['paypal_standard']['enable_osc_mail'] = 'True';
    ...
    function build() {
      ...
      if ($oscTemplate->_email_data['paypal_standard']['enable_osc_mail'] == 'True') {
        ...
        ob_start();
        require(DIR_WS_MODULES . 'pages/templates/email_paypal_standard_text.php');
        ...
        if (EMAIL_USE_HTML == 'true') {
          ob_start();
          require(DIR_WS_MODULES . 'pages/templates/email_paypal_standard_html.php');
    ...
    function preview() {
      global $oID, $currencies, $mode, $language;

      $order_id = $oID;

      if (tep_not_null($oID)) {
        require(DIR_FS_CATALOG . DIR_WS_MODULES . '/payment/paypal_standard.php');
        require(DIR_FS_CATALOG . DIR_WS_LANGUAGES . $language . '/modules/payment/paypal_standard.php');
        ...
        ob_start();
        if ($mode == 'text') {
          include(DIR_FS_CATALOG . DIR_WS_MODULES . 'pages/templates/email_paypal_standard_text.php');
        } else {
          include(DIR_FS_CATALOG . DIR_WS_MODULES . 'pages/templates/email_paypal_standard_html.php');
        }
