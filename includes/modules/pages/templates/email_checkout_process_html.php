                    ...
                    <tr>
                      <td align="center" valign="top" class="mobilePadding" style=" padding-top:40px; padding-right:40px; padding-bottom:30px; padding-left:40px;">
                        ...
                        <table id="content" width="100%">
                          <tr>
                            <td><?php echo EMAIL_TEXT_ORDER_NUMBER . ' ' . $insert_id . "<br />" .
                                           EMAIL_TEXT_INVOICE_URL . ' <a href="' . tep_href_link('account_history_info.php', 'order_id=' . $insert_id, 'SSL', false) . '">' . EMAIL_TEXT_MY_ORDER . "</a><br />" .
                          ...
                          <tr>
                            ...
                            <hr>
                            <?php
                                echo '<strong>' . $order->info['payment_method'] . '</strong><br />';
